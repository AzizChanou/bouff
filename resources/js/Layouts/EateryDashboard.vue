...
import MobileOperationSection from "@/Components/MobileOperationSection.vue";
...
const online = window.addEventListener("load", (event) => {
    return navigator.online;
});
</script>

<template>
    <div class="w-screen h-screen bg-bouffcover select-none">
        <div
