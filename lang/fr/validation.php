...
return [
    ...
    */
    ...
    'doesnt_end_with' => 'The :attribute ne peut se terminer par :values.',
    'doesnt_start_with' => 'The :attribute ne peut commencer par :values.',
    'email' => 'The :attribute doit être une adresse électronique valide',
    'ends_with' => 'The :attribute doit se terminer par l un des codes suivants :values.',
    ...
    'lt' => [
        'array' => 'The :attribute doit avoir moins d éléments que :valeur.',
        'file' => 'The :attribute doit être inférieur à :valeur kilobytes.',
        'numeric' => 'The :attribute doit être inférieur à :valeur.',
        'string' => 'The :attribute doit être inférieur à :valeur caractères.',
    ],
    'lte' => [
        'array' => 'The :attribute ne doit pas avoir plus de :valeur éléments.',
        'file' => 'The :attribute doit être inférieur ou égal à : valeur kilobytes.',
        'numeric' => 'The :attribute doit être inférieur ou égal à :valeur.',
        'string' => 'The :attribute doit être inférieur ou égal à :valeur caractères.',
    ],
    ...
    'mimes' => 'The :attribute doit être un fichier de type :valeurs.',
    'mimetypes' => 'The :attribute doit être un fichier de type  :valeurs.',
    'min' => [
    ...
    'prohibited_unless' => 'The :attribute est interdit si :other est dans :values.',
    ...
    'required_array_keys' => 'The :attribute  doit contenir des entrées  for: :values.',
    'required_if' => 'The :attribute est obligatoire lorsque :other est :value.',
    'required_unless' => 'The :attribute est obligatoire si :other est dans :values.',
    'required_with' => 'The :attribute est obligatoire lorsque :values est présente.',
    'required_with_all' => 'The :attribute est obligatoire lorsque :values est présente.',
    'required_without' => 'The :attribute est obligatoire lorsque :values n est pas présente.',
    'required_without_all' => 'The :attribute est obligatoire si aucune des :values est présente.',
    ...
    'starts_with' => 'The :attribute doit commencer par l un des éléments suivant :values.',
